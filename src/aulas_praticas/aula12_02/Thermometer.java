...
/**
 *
 * This class manages the data of a thermometer, specifically the current
 * temperature.
 */
public class Thermometer extends JPanel {
     ...
     *
     * @param cur the temperature to display. If cur is outside the range of the
     * thermometer, the mercury is set at its upper or lower bound.
     */
